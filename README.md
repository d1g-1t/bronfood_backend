...
**Перед созданием PR:**
- Запустите линтеры: `make lint` (если добавлена команда) или вручную
...
- [🐳 Docker Guide](./DOCKER.md) - Подробная документация по Docker
- [� Troubleshooting](./TROUBLESHOOTING.md) - Решение типичных проблем
- [🧪 Testing Guide](./TESTING.md) - Руководство по тестированию
- [�📚 API Documentation](http://localhost:8002/api/swagger) - После запуска проекта
- [📖 ReDoc](http://localhost:8002/api/redoc) - Альтернативная документация API
